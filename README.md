...
- **다음 예약(대기)**: 사용 중일 때 줄 서두면 앞 사람이 끝나는 순간 자동으로 시작
- **최근 사용 기록** 20건
...
**대기 예약은 언제 시작되나요?**
앞 사람의 **종료 시각부터** 자동으로 시작됩니다(등록 시 예상 시작/종료 시각이 표시됨).
늦게 오면 남은 시간이 줄어 있으니 **연장** 버튼을 쓰면 됩니다. 앞 사람이 "사용 종료"를 누르면 그 즉시 시작됩니다.
